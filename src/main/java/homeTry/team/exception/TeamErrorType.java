...
public enum TeamErrorType implements ErrorType {
    ...
    TEAM_NAME_ALREADY_EXISTS_EXCEPTION("Team400_004", HttpStatus.CONFLICT, "이미 동일한 이름의 팀이 존재합니다"),
    ALREADY_JOINED_EXCEPTION("Team400_005", HttpStatus.CONFLICT, "이미 해당 멤버는 팀에 가입되어 있습니다"),
